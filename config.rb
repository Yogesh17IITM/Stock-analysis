...
STOCK_TICKERS = "RELIANCE.NS, TCS.NS, INFY.NS, BEL.NS, HDFCBANK.NS, SOLARINDS.NS, GRAPHITE.NS, ATHERENERG.NS, HINDCOPPER.NS, DR REDDY.NS, NATIONALUM.NS, INDIGO.NS, MMTC.NS"
