...
STOCK_TICKERS = "RELIANCE.NS, TCS.NS, INFY.NS, HCLTECH.NS, BEL.NS, HDFCBANK.NS, SOLARINDS.NS, GRAPHITE.NS, ATHERENERG.NS, HINDCOPPER.NS, DRREDDY.NS, NATIONALUM.NS, INDIGO.NS, MMTC.NS"
